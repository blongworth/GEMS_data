...
nit_sat_umol <- cal_n2_sat(31, 23) # calculate for lab temp, sal, and pressure
ar_sat_umol <- cal_ar_sat(31, 23)
```
...
```{r}
df_proc <- norm_rga(df_wide, bg_29, bg_30, bg_30_28, bg_40, nit_sat_umol = nit_sat_umol, ar_sat_umol = ar_sat_umol, t0 = label_start)
```
