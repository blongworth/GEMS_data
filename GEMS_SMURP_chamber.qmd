...
```{r}
label_start <-  as.POSIXct("2024-09-11 13:31:00")
...
```{r}
umol_30_rate_sed_closed_init_2  <- calc_rate(df_proc, c(10000, 20000))
```
...
```{r}
umol_30_rate_sed_closed_max_2 <- calc_rate(df_proc, c(90000, 93000))
```

avg rate

```{r}
umol_30_rate_sed_closed_avg_2 <- calc_rate(df_proc, c(1000, 93000))
```
...
```{r}
label_start <-  as.POSIXct("2024-09-13 16:29:00")
...
```{r}
umol_30_rate_sed_open_init_2 <- coef(lm(umol_30 ~ et, data = sdf))[2] * 3600 * 24
```
...
```{r}
label_start <-  as.POSIXct("2024-09-13 12:33:00")
...
```{r}
umol_30_rate_grass_closed_init_2 <- coef(lm(umol_30 ~ et, data = sdf))[2] * 3600 * 24
```
...
```{r}
umol_30_rate_grass_closed_max_2 <- calc_rate(df_proc, c(47000, 50000))
```

avg rate

```{r}
umol_30_rate_grass_closed_avg_2 <- calc_rate(df_proc, c(3000, 50000))
```
...
```{r}
label_start <-  as.POSIXct("2024-09-11 14:04:00")
...
```{r}
umol_30_rate_grass_open_init_2 <- coef(lm(umol_30 ~ et, data = sdf))[2] * 3600 * 24
```
...
```{r}
umol_30_rate_grass_open_max_2 <- calc_rate(df_proc, c(40000, 42000))
```

avg rate

```{r}
umol_30_rate_grass_open_avg_2 <- calc_rate(df_proc, c(1000, 42000))
```
...
```{r}
rate_sum <- tibble(experiment = as.factor(c("sed-closed", "sed-open", "grass-closed", "grass-open", "sed-closed", "sed-open", "grass-closed", "grass-open")),
                   replicate = as.factor(c(1,1,1,1,2,2,2,2)),
                   argon = c(ar_loss_rate_sed_closed, ar_loss_rate_sed_open, ar_loss_rate_grass_closed, ar_loss_rate_grass_open, ar_loss_rate_sed_closed_2, ar_loss_rate_sed_open_2, ar_loss_rate_grass_closed_2, ar_loss_rate_grass_open_2),
                   dn_init = c(umol_30_rate_sed_closed_init, umol_30_rate_sed_open_init, umol_30_rate_grass_closed_init, umol_30_rate_grass_open_init, umol_30_rate_sed_closed_init_2, umol_30_rate_sed_open_init_2, umol_30_rate_grass_closed_init_2, umol_30_rate_grass_open_init_2),
                   dn_50 = c(umol_30_rate_sed_closed_50, umol_30_rate_sed_open_50, umol_30_rate_grass_closed_50, umol_30_rate_grass_open_50, umol_30_rate_sed_closed_50_2, umol_30_rate_sed_open_50_2, umol_30_rate_grass_closed_50_2, umol_30_rate_grass_open_50_2),
                   dn_avg = c(umol_30_rate_sed_closed_avg, umol_30_rate_sed_open_avg, umol_30_rate_grass_closed_avg, umol_30_rate_grass_open_avg, umol_30_rate_sed_closed_avg_2, umol_30_rate_sed_open_avg_2, umol_30_rate_grass_closed_avg_2, umol_30_rate_grass_open_avg_2),
                   dn_max = c(umol_30_rate_sed_closed_max, umol_30_rate_sed_open_max, umol_30_rate_grass_closed_max, umol_30_rate_grass_open_max, umol_30_rate_sed_closed_max_2, umol_30_rate_sed_open_max_2, umol_30_rate_grass_closed_max_2, umol_30_rate_grass_open_max_2),
                   grass = c(FALSE, FALSE, TRUE, TRUE, FALSE, FALSE, TRUE, TRUE), 
                   open = c(FALSE, TRUE, FALSE, TRUE, FALSE, TRUE, FALSE, TRUE),
                   )

knitr::kable(rate_sum, digits = c(1, 1, 3, 0, 0, 0, 0, 1, 1), col.names = c("Experiment", "Replicate", "Ar loss", "Initial DN", "DN to 50% Ar", "Avg DN", "Max DN", "Grass", "Open sided"))
```
