...
```{r}
df_proc <- norm_rga(df_wide, bg_29, bg_30, nit_sat_umol = 600, t0 = label_start)
```
...
```{r}
label_start <-  as.POSIXct("2024-09-24 13:26:00")
...
```{r}
rate_sum <- tibble(experiment = as.factor(c("sed-closed", "sed-open", "grass-closed", "grass-open", "sed-closed", "sed-open", "grass-closed", "grass-open", "sed-closed")),
                   replicate = as.factor(c(1,1,1,1,2,2,2,2,3)),
                   argon = c(ar_loss_rate_sed_closed, ar_loss_rate_sed_open, ar_loss_rate_grass_closed, ar_loss_rate_grass_open, ar_loss_rate_sed_closed_2, ar_loss_rate_sed_open_2, ar_loss_rate_grass_closed_2, ar_loss_rate_grass_open_2, ar_loss_rate_sed_closed_3),
                   t_anox = c(10000, 12000,7000, 14000, 28000, 17000, 6000, 8000, 15000)/3600,
                   t_peak = c(72000, 41000, 29000, 44000, 92000, 65000, 47000, 41000, 48000)/3600,
                   dn_init = c(umol_30_rate_sed_closed_init, umol_30_rate_sed_open_init, umol_30_rate_grass_closed_init, umol_30_rate_grass_open_init, umol_30_rate_sed_closed_init_2, umol_30_rate_sed_open_init_2, umol_30_rate_grass_closed_init_2, umol_30_rate_grass_open_init_2, umol_30_rate_sed_closed_init_3),
                   dn_50 = c(umol_30_rate_sed_closed_50, umol_30_rate_sed_open_50, umol_30_rate_grass_closed_50, umol_30_rate_grass_open_50, umol_30_rate_sed_closed_50_2, umol_30_rate_sed_open_50_2, umol_30_rate_grass_closed_50_2, umol_30_rate_grass_open_50_2, umol_30_rate_sed_closed_50_3),
                   dn_avg = c(umol_30_rate_sed_closed_avg, umol_30_rate_sed_open_avg, umol_30_rate_grass_closed_avg, umol_30_rate_grass_open_avg, umol_30_rate_sed_closed_avg_2, umol_30_rate_sed_open_avg_2, umol_30_rate_grass_closed_avg_2, umol_30_rate_grass_open_avg_2, umol_30_rate_sed_closed_avg_3),
                   dn_max = c(umol_30_rate_sed_closed_max, umol_30_rate_sed_open_max, umol_30_rate_grass_closed_max, umol_30_rate_grass_open_max, umol_30_rate_sed_closed_max_2, umol_30_rate_sed_open_max_2, umol_30_rate_grass_closed_max_2, umol_30_rate_grass_open_max_2, umol_30_rate_sed_closed_max_3),
                   grass = c(FALSE, FALSE, TRUE, TRUE, FALSE, FALSE, TRUE, TRUE, FALSE), 
                   open = c(FALSE, TRUE, FALSE, TRUE, FALSE, TRUE, FALSE, TRUE, FALSE),
                   )
