...
rate_sum <- tibble(experiment = c("sed-closed", "sed-open", "grass-closed", "grass-open"),
                   ...
                   dn_50 = c(umol_30_rate_sed_closed_50, umol_30_rate_sed_open_50, umol_30_rate_grass_closed_50, umol_30_rate_grass_open_50),
...
knitr::kable(rate_sum, digits = c(1, 3, 0, 0, 0, 0, 1, 1), col.names = c("Experiment", "Ar loss", "Initial DN", "DN to 50% Ar", "Avg DN", "Max DN", "Grass", "Open sided"))
```
```{r}
...
dn50 <- ggplot(rate_sum, aes(experiment, dn_50_cor)) +
  geom_bar(stat = "identity") +
